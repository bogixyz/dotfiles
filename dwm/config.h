...
static const char *fonts[]          = { "MonaspiceAr Nerd Font:size=10" };
static const char dmenufont[]       = "MonaspiceAr Nerd Font:size=10";
static const int gappx 		    = 6;
#include "/home/bogi/.cache/wal/colors-wal-dwm.h"
